...
export const ButtonsCard = ({
    ...
    return (
        <div
            onClick={onClick}
            className={cn(
                "h-60 w-full bg-transparent rounded-xl border-none  dark:bg-black dark:border-white/[0.2] hover:border-neutral-200 group/btn overflow-hidden relative flex items-center justify-center",
                className
            )}
        >
